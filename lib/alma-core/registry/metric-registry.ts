...
export const METRIC_REGISTRY = {
  ...
  menstruation_start: event("menstruation_start", "Начало менструации", "cycle", "cycle_event"),
  ovulation_observation: event("ovulation_observation", "Овуляция отмечена", "cycle", "cycle_event"),
  estimated_ovulation: event("estimated_ovulation", "Расчётная овуляция", "cycle", "cycle_event"),
  fertile_window_observation: event("fertile_window_observation", "Фертильное окно отмечено", "cycle", "cycle_event", "interval_event"),
  estimated_fertile_window: event("estimated_fertile_window", "Расчётное фертильное окно", "cycle", "cycle_event", "interval_event"),
